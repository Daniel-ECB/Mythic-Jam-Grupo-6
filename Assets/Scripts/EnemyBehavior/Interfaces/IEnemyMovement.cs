...
public interface IEnemyMovement
{
    ...
    EnemyMovementManager enemyMovementScript { get; set; }
    ...
    //script is referenced and write this script's name there. You need to implement the methods defined here, such as Move, and it must access the EnemyMovementManager)
